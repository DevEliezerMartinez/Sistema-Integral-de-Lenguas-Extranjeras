...
const images = [
  { src: "/CLE/Opt/Carousel/1.webp", alt: "Alumnos del CLE" },
  { src: "/CLE/Opt/Carousel/2.webp", alt: "Alumnos del CLE" },
  { src: "/CLE/Opt/Carousel/3.webp", alt: "Alumnos del CLE" },
  { src: "/CLE/Opt/Carousel/4.webp", alt: "Alumnos del CLE" },
    ...
    <div className="  mt-8">
      ...
      <section id="Contenedor Minicards" className="flex  justify-around  p-4">
        <div id="DataCard" className="flex flex-col items-center  w-1/5">
          <img className="w-12" alt="Logo escolar" src="/CLE/Opt/SVG/academic.svg"></img>
          <p className="Montserrat font-normal text-center">Con el objetivo de fomentar el perfil academico</p>
        </div>
        <div id="DataCard" className="flex flex-col items-center  w-1/5">
          <img className="w-12" alt="Logo escolar" src="/CLE/Opt/SVG/group.svg"></img>
          <p className="Montserrat font-normal text-center">Seguimiento por grupo para practicar sus habilidades</p>
        </div>
        <div id="DataCard" className="flex flex-col items-center  w-1/5">
          <img className="w-12" alt="Logo escolar" src="/CLE/Opt/SVG/teacher.svg"></img>
