      ...
      <div className="md:hidden">
        ...
        {showMenu && (
          <ul className="absolute top-16 right-4 bg-[#1B396A] p-4 rounded-md">
            <Link to="/login">
              <a href="#acerca-del-cle" className="text-white hover:font-semibold transition duration-300">Login</a>
            </Link>
            <li>
            <Link to="/Registro">
              <a href="#requisitos" className="text-white hover:font-semibold transition duration-300">Registro</a>
            </Link>
            </li>
            <li>
